...
repositories {
    ...
    // You can declare and Maven/Ivy/file repository here
    mavenCentral()
...
//    implementation("org.jetbrains.kotlin:kotlin0stdlib-jdk7")
